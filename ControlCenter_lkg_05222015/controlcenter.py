...
matlab = open('/home/pi/Eco-Dolphin_lkg_05292015/ControlCenter_lkg_05222015/output.m','w')
prevx = 0
prevy = 0
prevz = 0
preanglex = 0
...
while 1:
   ...
   if location == destination:
        ...
        if response == 'Ready':
                ...
                matlab.write('Current Time' + '\n')
                matlab.write('%01d\n' % time.clock())
                print 'Prev Time' , prevtime
                matlab.write('Prev Time' + '\n')
                matlab.write('%01d\n' % prevtime)
                print 'Elasped Time' , difftime
                matlab.write('Elasped Time' + '\n')
                matlab.write('%01d\n' % difftime)
